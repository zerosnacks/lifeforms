...
/// @title ZS Vault Factory
/// @author Inherits from Rari Capital (https://github.com/Rari-Capital/vaults/blob/main/src/VaultFactory.sol)
...
contract VaultFactory is Auth {
    ...
    function deployVault(ERC20 underlying) external requiresAuth returns (Vault vault) {
