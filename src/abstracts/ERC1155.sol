...
/// @notice Modern and gas-optimized ERC-1155 implementation with EIP-2612 extension.
...
abstract contract ERC1155 {
    ...
    function _callonERC1155Received(
        ...
        if (to.code.length != 0) {
            ...
            (, bytes memory returned) = to.staticcall{gas: gasLimit}(
                abi.encodeWithSelector(0xf23a6e61, msg.sender, from, id, amount, data)
            );
    ...
    function _callonERC1155BatchReceived(
        ...
        if (to.code.length != 0) {
            ...
            (, bytes memory returned) = to.staticcall{gas: gasLimit}(
                abi.encodeWithSelector(0xbc197c81, msg.sender, from, ids, amounts, data)
            );
